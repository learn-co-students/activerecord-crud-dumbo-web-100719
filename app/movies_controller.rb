...
def can_find_by_multiple_attributes
  ...
  # movie = Movie.where('title = :title or release_date = :release_date or director = :director', title: :title, release_date: :release_date, director: :director)
